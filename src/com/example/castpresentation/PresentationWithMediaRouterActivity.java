...
/**
 * <h3>PresentationWithMediaRouterActivity Activity</h3>
 * <p>
 * This demonstrates how to create an activity that shows some content on a
 ...
 * routes using a menu item. When a presentation display is available, we stop
 * showing content in the main activity and instead open up a
 * {@link Presentation} on the preferred presentation display. When a
 * presentation display is removed, we revert to showing content in the main
 * activity. We also write information about displays and display-related events
 ...
 * simulated secondary displays. Each display will appear in the list along with
 * a checkbox to show a presentation on that display.
 * </p>
 */
